...
public class MatterBallItem extends Item {
    ...
    public @NotNull InteractionResult useOn(@NotNull UseOnContext context) {
        ...
        IItemHandler handler = level.getCapability(Capabilities.ItemHandler.BLOCK, context.getClickedPos(), face);
        if (handler == null) {
            handler = level.getCapability(Capabilities.ItemHandler.BLOCK, context.getClickedPos(), null);
        }
        if (handler == null) {
            return InteractionResult.PASS;
        }
