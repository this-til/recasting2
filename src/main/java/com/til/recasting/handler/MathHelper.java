...
public class MathHelper {
    ...
    public static float nextFloat(Random random, float minimum, float maximum) {
        return minimum >= maximum
                ? minimum
                : random.nextFloat() * (maximum - minimum) + minimum;
    }
    ...
    public static float approach(float p_203300_0_, float p_203300_1_, float p_203300_2_) {
        ...
        return p_203300_0_ < p_203300_1_
                ? clamp(p_203300_0_ + p_203300_2_, p_203300_0_, p_203300_1_)
    ...
    public static float approachDegrees(float p_203303_0_, float p_203303_1_, float p_203303_2_) {
        float f = warpDegreeDifference(p_203303_0_, p_203303_1_);
    ...
    public static int log2(int value) {
        return log2DeBruijn(value) - (isPowerOfTwo(value)
                ? 0
                : 1);
    }
    ...
    /**
     * 按 ResourceKey 读取附魔等级（1.21 ItemStack 仅接受 Holder）。
     */
