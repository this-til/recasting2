...
public class Config {
    ...
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> VANILLA_ART_REPLACE_ITEM_CLASS_PATTERNS;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> VANILLA_ART_REPLACE_SA_PATTERNS;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> VANILLA_ART_REPLACE_SE_PATTERNS;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> VANILLA_ART_REPLACE_ENCHANTMENT_PATTERNS;
    ...
    static {
        ...
        VANILLA_ART_REPLACE_SA_PATTERNS = BUILDER
                ...
                .defineListAllowEmpty(List.of("saPatterns"), List::of, entry -> entry instanceof String);
        VANILLA_ART_REPLACE_SE_PATTERNS = BUILDER
                .comment(
                        "刀上 SE id 正则，任意一条整串匹配则不接管。",
                        "匹配方式为 Java Matcher.matches。例 srelic:.*"
                )
                .defineListAllowEmpty(List.of("sePatterns"), List::of, entry -> entry instanceof String);
        VANILLA_ART_REPLACE_ENCHANTMENT_PATTERNS = BUILDER
                .comment(
                        "刀上附魔 id 正则，任意一条整串匹配则不接管。",
                        "匹配方式为 Java Matcher.matches。"
                )
                .defineListAllowEmpty(List.of("enchantmentPatterns"), List::of, entry -> entry instanceof String);
        BUILDER.pop();
    }
