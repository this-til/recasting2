...
public class RecastingRecipes extends RecipeProvider {
    ...
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
        saveObsessionFlameRecipe(consumer);
        saveMemoryFlameRecipe(consumer);
        saveSinFlameRecipe(consumer);
        saveHolyFlameRecipe(consumer);
        saveChaosFlameRecipe(consumer);
        saveIceCoreFlameRecipe(consumer);
        saveOtherShoreFlameRecipe(consumer);
        saveKarmaFlameRecipe(consumer);
        saveCradleFlameRecipe(consumer);
        saveAbyssFlameRecipe(consumer);
        saveRoyalFlameRecipe(consumer);
        saveOuroborosFlameRecipe(consumer);
        saveMirrorFlameRecipe(consumer);
        saveLastWordsFlameRecipe(consumer);
        saveTideFlameRecipe(consumer);
        savePoetryAshFlameRecipe(consumer);
        saveMirageFlameRecipe(consumer);
        saveCraftsmanFlameRecipe(consumer);
        saveIronMediumSoulCubeRecipe(consumer);
        saveGoldMediumSoulCubeRecipe(consumer);
        saveCopperMediumSoulCubeRecipe(consumer);
        saveDiamondMediumSoulCubeRecipe(consumer);
        saveEmeraldMediumSoulCubeRecipe(consumer);
        saveNetheriteMediumSoulCubeRecipe(consumer);
        saveLapisMediumSoulCubeRecipe(consumer);
        saveRedstoneMediumSoulCubeRecipe(consumer);
        saveGatheringPartingVariantRecipe(consumer);
        saveUpgradeVariantRecipe(consumer);
        saveUpgradeVariant2Recipe(consumer);
        saveUpgradeVariant3Recipe(consumer);
        saveUpgradeVariant4Recipe(consumer);
    }
     ...
     */
    private static void saveObsessionFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("obsession_flame_recipe");
     ...
     */
    private static void saveMemoryFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("memory_flame_recipe");
     ...
     */
    private static void saveSinFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("sin_flame_recipe");
     ...
     */
    private static void saveHolyFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("holy_flame_recipe");
     ...
     */
    private static void saveChaosFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("chaos_flame_recipe");
     ...
     */
    private static void saveIceCoreFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("ice_core_flame_recipe");
     ...
     */
    private static void saveOtherShoreFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("other_shore_flame_recipe");
     ...
     */
    private static void saveKarmaFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("karma_flame_recipe");
     ...
     */
    private static void saveCradleFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("cradle_flame_recipe");
     ...
     */
    private static void saveAbyssFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("abyss_flame_recipe");
     ...
     */
    private static void saveRoyalFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("royal_flame_recipe");
     ...
     */
    private static void saveOuroborosFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("ouroboros_flame_recipe");
     ...
     */
    private static void saveMirrorFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("mirror_flame_recipe");
     ...
     */
    private static void saveLastWordsFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("last_words_flame_recipe");
     ...
     */
    private static void saveTideFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("tide_flame_recipe");
     ...
     * B=附魔书, P=PROUDSOUL
     */
    private static void savePoetryAshFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("poetry_ash_flame_recipe");
     ...
     */
    private static void saveMirageFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("mirage_flame_recipe");
     ...
     */
    private static void saveCraftsmanFlameRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("craftsman_flame_recipe");
     ...
     */
    private static void saveIronMediumSoulCubeRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("iron_medium_soul_cube_recipe");
     ...
     */
    private static void saveGoldMediumSoulCubeRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("gold_medium_soul_cube_recipe");
     ...
     */
    private static void saveCopperMediumSoulCubeRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("copper_medium_soul_cube_recipe");
     ...
     */
    private static void saveDiamondMediumSoulCubeRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("diamond_medium_soul_cube_recipe");
     ...
     */
    private static void saveEmeraldMediumSoulCubeRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("emerald_medium_soul_cube_recipe");
     ...
     */
    private static void saveNetheriteMediumSoulCubeRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("netherite_medium_soul_cube_recipe");
     ...
     */
    private static void saveLapisMediumSoulCubeRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("lapis_medium_soul_cube_recipe");
     ...
     */
    private static void saveRedstoneMediumSoulCubeRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("redstone_medium_soul_cube_recipe");
     ...
     */
    private static void saveGatheringPartingVariantRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("gathering_parting_variant_recipe");
     ...
     */
    private static void saveUpgradeVariantRecipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("upgrade_variant_recipe");
     ...
     */
    private static void saveUpgradeVariant2Recipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("upgrade_variant_2_recipe");
     ...
     */
    private static void saveUpgradeVariant3Recipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("upgrade_variant_3_recipe");
     ...
     */
    private static void saveUpgradeVariant4Recipe(Consumer<FinishedRecipe> consumer) {
        ResourceLocation recipeId = Recasting.prefix("upgrade_variant_4_recipe");
