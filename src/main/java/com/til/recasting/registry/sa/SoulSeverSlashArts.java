...
public class SoulSeverSlashArts extends ExtendedSlashArts {
    ...
    private void activate(LivingEntity livingEntity) {
        ...
        BladeStateAccess.of(mainHandItem).ifPresent(slashBladeState -> {
            PropertiesDefinitionExtension propertiesDefinitionExtension = AttackHelper.propertiesOf(mainHandItem);
            RenderDefinitionExtension renderDefinitionExtension = mainHandItem.getOrDefault(
    ...
    private void spawnJudgementCut(
        ...
        RecastingAttachments.timeRun(livingEntity).addTimerCell(
