...
public final class RecastingSlashBladeKeys {
    ...
    public static final ResourceKey<SlashBladeDefinition> FINAL_GLOW_LAMBDA = lambdaOf(FINAL_GLOW);
    public static final ResourceKey<SlashBladeDefinition> VAULT_SCALE = ResourceKey.create(SlashBladeDefinition.REGISTRY_KEY, R.Slashblade.Special.vaultScale);
    public static final ResourceKey<SlashBladeDefinition> VAULT_SCALE_LAMBDA = lambdaOf(VAULT_SCALE);
    ...
    public static final ResourceKey<SlashBladeDefinition> JIE_YUAN_DOG = ResourceKey.create(SlashBladeDefinition.REGISTRY_KEY, R.Slashblade.Special.jieYuanDog);
