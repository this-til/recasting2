...
public class SummondSwordEntity extends StandardizationAttackEntity {
    ...
    protected static final EntityDataAccessor<Integer> HIT_ENTITY_ID =
            SynchedEntityData.defineId(SummondSwordEntity.class, EntityDataSerializers.INT);

    protected static final EntityDataAccessor<Integer> MAX_PIERCE =
            SynchedEntityData.defineId(SummondSwordEntity.class, EntityDataSerializers.INT);

    protected static final EntityDataAccessor<Integer> BREAK_DELAY =
            SynchedEntityData.defineId(SummondSwordEntity.class, EntityDataSerializers.INT);

    protected static final EntityDataAccessor<Integer> START_DELAY =
            SynchedEntityData.defineId(SummondSwordEntity.class, EntityDataSerializers.INT);

    protected static final EntityDataAccessor<Float> SEEP =
            SynchedEntityData.defineId(SummondSwordEntity.class, EntityDataSerializers.FLOAT);

    protected static final EntityDataAccessor<Boolean> IGNORING_BLOCK =
            SynchedEntityData.defineId(SummondSwordEntity.class, EntityDataSerializers.BOOLEAN);

    protected static final EntityDataAccessor<Integer> ACTION_TYPE =
            SynchedEntityData.defineId(SummondSwordEntity.class, EntityDataSerializers.INT);
    ...
    public static final ResourceLocation DEFAULT_MODEL =
            ResourceLocation.fromNamespaceAndPath(SlashBlade.MODID, "model/util/ss.obj");
    public static final ResourceLocation DEFAULT_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(SlashBlade.MODID, "model/util/ss.png");
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(ACTION_TYPE, ActionType.PREPARE.ordinal());
    }
    ...
    public void setHitEntity(@Nullable Entity hitEntity) {
        entityData.set(HIT_ENTITY_ID, hitEntity != null ? hitEntity.getId() : -1);
