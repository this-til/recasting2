...
public class SummondSpiralSwordEntity extends SummondSwordEntity {
     ...
     * 旋转中心实体的ID
     */
    protected static final EntityDataAccessor<Integer> CENTER_ENTITY_ID =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.INT);

    /**
     * 旋转速度（度/tick）
     */
    protected static final EntityDataAccessor<Float> ROTATION_SPEED =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.FLOAT);
     ...
     * < 1.0: 速度越来越慢（减速）
     */
    protected static final EntityDataAccessor<Float> ROTATION_SPEED_MODIFIER =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.FLOAT);

    /**
     * 当前旋转角度（度）
     */
    protected static final EntityDataAccessor<Float> ROTATION_ANGLE =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.FLOAT);

    /**
     * 旋转半径
     */
    protected static final EntityDataAccessor<Float> ROTATION_RADIUS =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.FLOAT);
     ...
     * < 1.0: 半径越来越小（向内收缩）
     */
    protected static final EntityDataAccessor<Float> ROTATION_RADIUS_MODIFIER =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.FLOAT);

    /**
     * 旋转轴 X 分量
     */
    protected static final EntityDataAccessor<Float> ROTATION_AXIS_X =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.FLOAT);

    /**
     * 旋转轴 Y 分量
     */
    protected static final EntityDataAccessor<Float> ROTATION_AXIS_Y =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.FLOAT);

    /**
     * 旋转轴 Z 分量
     */
    protected static final EntityDataAccessor<Float> ROTATION_AXIS_Z =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.FLOAT);

    /**
     * 旋转朝向（true=朝外, false=朝内指向中心）
     */
    protected static final EntityDataAccessor<Boolean> ROTATION_DIRECTION_OUTWARD =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.BOOLEAN);
     ...
     */
    protected static final EntityDataAccessor<Boolean> CAN_ATTACK_DURING_ROTATION =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.BOOLEAN);

    /**
     * 旋转中心的高度偏移（相对于中心实体的 eyeHeight / 2.0）
     */
    protected static final EntityDataAccessor<Float> CENTER_HEIGHT_OFFSET =
            SynchedEntityData.defineId(SummondSpiralSwordEntity.class, EntityDataSerializers.FLOAT);

    @Nullable
    protected Entity centerEntity;

    public SummondSpiralSwordEntity(
            EntityType<? extends SummondSpiralSwordEntity> entityTypeIn,
            Level worldIn,
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(CENTER_ENTITY_ID, -1);
        builder.define(ROTATION_SPEED, 6.0f);
        builder.define(ROTATION_SPEED_MODIFIER, 1.0f);
        builder.define(ROTATION_ANGLE, 0.0f);
        builder.define(ROTATION_RADIUS, 2.0f);
        builder.define(ROTATION_RADIUS_MODIFIER, 1.0f);
        builder.define(ROTATION_AXIS_X, 0.0f);
        builder.define(ROTATION_AXIS_Y, 1.0f);
        builder.define(ROTATION_AXIS_Z, 0.0f);
        builder.define(ROTATION_DIRECTION_OUTWARD, true);
        builder.define(CAN_ATTACK_DURING_ROTATION, false);
        builder.define(CENTER_HEIGHT_OFFSET, 0.0f);
    }
