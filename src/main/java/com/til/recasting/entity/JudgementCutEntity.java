...
public class JudgementCutEntity extends ContinuousDamageEntity {
    ...
    private static final ResourceLocation MODEL_LOCATION =
            ResourceLocation.fromNamespaceAndPath(SlashBlade.MODID, "model/util/slashdim.obj");
    private static final ResourceLocation TEXTURE_LOCATION =
            ResourceLocation.fromNamespaceAndPath(SlashBlade.MODID, "model/util/slashdim.png");
