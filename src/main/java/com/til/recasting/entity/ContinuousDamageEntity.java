...
public abstract class ContinuousDamageEntity extends StandardizationAttackEntity {
    ...
    protected static final EntityDataAccessor<Integer> ATTACK_INTERVAL =
            SynchedEntityData.defineId(ContinuousDamageEntity.class, EntityDataSerializers.INT);

    protected static final EntityDataAccessor<Boolean> REPEATED_ATTACK =
            SynchedEntityData.defineId(ContinuousDamageEntity.class, EntityDataSerializers.BOOLEAN);

    protected static final EntityDataAccessor<Boolean> SINGLE_ATTACK =
            SynchedEntityData.defineId(ContinuousDamageEntity.class, EntityDataSerializers.BOOLEAN);

    protected static final EntityDataAccessor<Float> PARAMETER_RANGE =
            SynchedEntityData.defineId(ContinuousDamageEntity.class, EntityDataSerializers.FLOAT);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(SINGLE_ATTACK, false);
