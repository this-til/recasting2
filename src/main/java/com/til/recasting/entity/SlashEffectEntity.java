...
public class SlashEffectEntity extends ContinuousDamageEntity {
    ...
    protected static final EntityDataAccessor<Boolean> THUMP =
            SynchedEntityData.defineId(SlashEffectEntity.class, EntityDataSerializers.BOOLEAN);

    protected static final EntityDataAccessor<Float> ROTATION_OFFSET =
            SynchedEntityData.defineId(SlashEffectEntity.class, EntityDataSerializers.FLOAT);
    ...
    private static final ResourceLocation MODEL_LOCATION =
            ResourceLocation.fromNamespaceAndPath(SlashBlade.MODID, "model/util/slash.obj");
    private static final ResourceLocation TEXTURE_LOCATION =
            ResourceLocation.fromNamespaceAndPath(SlashBlade.MODID, "model/util/slash.png");

    public SlashEffectEntity(EntityType<? extends SlashEffectEntity> entityTypeIn, Level worldIn, LivingEntity shooting) {
        super(entityTypeIn, worldIn, shooting);
        setMaxLifeTime(10);
        setModel(MODEL_LOCATION);
        setTexture(TEXTURE_LOCATION);
