...
public class SlashBladeRecipes extends RecipeProvider {
    ...
    public SlashBladeRecipes(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
    ...
    protected void buildRecipes(@NotNull RecipeOutput output) {
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BROADSWORD_WOOD.location())
                ...
                .save(output, Recasting.prefix("broadsword_wood_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.GREEN_BLADE_WOOD.location())
                ...
                .define('P', SlashBladeItems.PROUDSOUL.get())
                .unlockedBy("has_stick", has(Items.STICK))
                .save(output, Recasting.prefix("green_blade_wood_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BROADSWORD_IRON.location())
                ...
                .save(output, Recasting.prefix("broadsword_iron_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.GREEN_BLADE_IRON.location())
                ...
                .define('I', SlashBladeItems.PROUDSOUL_INGOT.get())
                .unlockedBy("has_iron_ingot", has(Items.IRON_INGOT))
                .save(output, Recasting.prefix("green_blade_iron_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.SHINE_TEA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(1000)
                                .refineCount(500)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.LUCK_OF_THE_SEA), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.LURE), 2))
                                .build()))
                ...
                .save(output, Recasting.prefix("shine_tea_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.SHINE_TEA_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .refineCount(1000)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.LUCK_OF_THE_SEA), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.LURE), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SILK_TOUCH), 1))
                                .build()))
                .define('I', RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get())
                .unlockedBy("has_gold_medium_soul_cube", has(RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("shine_tea_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BRILLIANT_TEA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.LURE), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SILK_TOUCH), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.EFFICIENCY), 5))
                                .build()))
                .define('I', RecastingItems.ILLUMINATING_TRUTH_CORE.get())
                .unlockedBy("has_illuminating_truth_core", has(RecastingItems.ILLUMINATING_TRUTH_CORE.get()))
                .save(output, Recasting.prefix("brilliant_tea_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BRILLIANT_TEA_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SILK_TOUCH), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.EFFICIENCY), 5))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FORTUNE), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.LOYALTY), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.RIPTIDE), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.MENDING), 1))
                                .build()))
                .define('I', RecastingItems.ILLUMINATING_TRUTH_CORE.get())
                .unlockedBy("has_illuminating_truth_core", has(RecastingItems.ILLUMINATING_TRUTH_CORE.get()))
                .save(output, Recasting.prefix("brilliant_tea_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BRIARLAND.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(5000)
                                .refineCount(600)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.THORNS), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.PROTECTION), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FORTUNE), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SILK_TOUCH), 1))
                                .build()))
                ...
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("briarland_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BRIARLAND_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SILK_TOUCH), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.EFFICIENCY), 5))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.UNBREAKING), 3))
                                .build()))
                ...
                .unlockedBy("has_blazing_flame_core", has(RecastingItems.BLAZING_FLAME_CORE.get()))
                .save(output, Recasting.prefix("briarland_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.SHINE_GOLD.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(1000)
                                .proudSoul(50000)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.EFFICIENCY), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SILK_TOUCH), 1))
                                .build()))
                .define('I', RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get())
                .unlockedBy("has_gold_medium_soul_cube", has(RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("shine_gold_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.SHINE_GOLD_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.EFFICIENCY), 5))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SILK_TOUCH), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FORTUNE), 1))
                                .build()))
                .define('I', RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get())
                .unlockedBy("has_gold_medium_soul_cube", has(RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("shine_gold_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BRILLIANT_GOLD.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SILK_TOUCH), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FORTUNE), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.LUCK_OF_THE_SEA), 2))
                                .build()))
                .define('I', RecastingItems.ILLUMINATING_TRUTH_CORE.get())
                .unlockedBy("has_illuminating_truth_core", has(RecastingItems.ILLUMINATING_TRUTH_CORE.get()))
                .save(output, Recasting.prefix("brilliant_gold_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BRILLIANT_GOLD_LAMBDA.location())
                ...
                .define('I', RecastingItems.ILLUMINATING_TRUTH_CORE.get())
                .unlockedBy("has_illuminating_truth_core", has(RecastingItems.ILLUMINATING_TRUTH_CORE.get()))
                .save(output, Recasting.prefix("brilliant_gold_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BROKEN_WHITE.location())
                ...
                .unlockedBy("has_obsession_flame", has(RecastingItems.OBSESSION_FLAME.get()))
                .save(output, Recasting.prefix("broken_white_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.ART_KNIFE.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(50)
                                .refineCount(20)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.EFFICIENCY), 2))
                                .build()))
                .define('C', RecastingItems.CRAFTSMAN_FLAME.get())
                .unlockedBy("has_craftsman_flame", has(RecastingItems.CRAFTSMAN_FLAME.get()))
                .save(output, Recasting.prefix("art_knife_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BA_GUA.location())
                ...
                .define('S',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(500)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SMITE), 2))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SHARPNESS), 2))
                                .build()))
                .define('P', RecastingItems.POETRY_ASH_FLAME.get())
                .define('W', Items.WHITE_WOOL)
                .define('K', Items.BLACK_WOOL)
                .define('C', RecastingItems.CHAOS_FLAME.get())
                .unlockedBy("has_poetry_ash_flame", has(RecastingItems.POETRY_ASH_FLAME.get()))
                .save(output, Recasting.prefix("ba_gua_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BA_GUA_BIG.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(2000)
                                .refineCount(100)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SMITE), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SHARPNESS), 2))
                                .build()))
                .define('P', RecastingItems.POETRY_ASH_FLAME.get())
                .define('C', RecastingItems.COPPER_MEDIUM_SOUL_CUBE.get())
                .unlockedBy("has_copper_medium_soul_cube", has(RecastingItems.COPPER_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("ba_gua_big_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BA_GUA_BIG_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(5000)
                                .refineCount(300)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SMITE), 5))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SHARPNESS), 2))
                                .build()))
                .define('C', RecastingItems.COPPER_MEDIUM_SOUL_CUBE.get())
                .define('I', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.IMPACT.getId(), 1))
                .unlockedBy("has_copper_medium_soul_cube", has(RecastingItems.COPPER_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("ba_gua_big_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.SUPREME_POLE.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .refineCount(800)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SMITE), 5))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SHARPNESS), 5))
                                .build()))
                .define('P', RecastingItems.POETRY_ASH_FLAME.get())
                .define('C', RecastingItems.FROST_VORTEX_CORE.get())
                .define('W', Items.WHITE_WOOL)
                .define('K', Items.BLACK_WOOL)
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("supreme_pole_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.SUPREME_POLE_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SMITE), 5))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SHARPNESS), 5))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.LOOTING), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.UNBREAKING), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.MENDING), 1))
                                .build()))
                .define('C', RecastingItems.ABYSS_DEPTH_CORE.get())
                .define('I', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.IMPACT.getId(), 1))
                .unlockedBy("has_abyss_depth_core", has(RecastingItems.ABYSS_DEPTH_CORE.get()))
                .save(output, Recasting.prefix("supreme_pole_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BLACK.location())
                ...
                .unlockedBy("has_sin_flame", has(RecastingItems.SIN_FLAME.get()))
                .save(output, Recasting.prefix("black_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.UMBRELLA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(500)
                                .refineCount(100)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SHARPNESS), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.KNOCKBACK), 2))
                                .build()))
                ...
                .save(output, Recasting.prefix("umbrella_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.UMBRELLA_LAMBDA.location())
                ...
                .unlockedBy("has_netherite_medium_soul_cube", has(RecastingItems.NETHERITE_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("umbrella_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.ONIKIRI.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SHARPNESS), 5))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.KNOCKBACK), 2))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SWEEPING_EDGE), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.BLAST_PROTECTION), 2))
                                .build()))
                .define('C', RecastingItems.FROST_VORTEX_CORE.get())
                .define('S', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.SHOCK.getId(), 1))
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("onikiri_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.ONIKIRI_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.KNOCKBACK), 2))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SWEEPING_EDGE), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.BLAST_PROTECTION), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SMITE), 5))
                                .build()))
                .define('C', RecastingItems.BLAZING_FLAME_CORE.get())
                .define('O', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.OVERLOAD.getId(), 1))
                .unlockedBy("has_blazing_flame_core", has(RecastingItems.BLAZING_FLAME_CORE.get()))
                .save(output, Recasting.prefix("onikiri_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BLUE_CLOUD.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(500)
                                .refineCount(20)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FEATHER_FALLING), 4))
                                .build()))
                ...
                .save(output, Recasting.prefix("blue_cloud_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.BLUE_CLOUD_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .refineCount(125)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FEATHER_FALLING), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.DEPTH_STRIDER), 3))
                                .build()))
                .define('E', RecastingItems.EMERALD_MEDIUM_SOUL_CUBE.get())
                .define('X', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.CROSS_CHOP.getId(), 1))
                .unlockedBy("has_emerald_medium_soul_cube", has(RecastingItems.EMERALD_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("blue_cloud_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.COOL_MINT.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FEATHER_FALLING), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.DEPTH_STRIDER), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SOUL_SPEED), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.AQUA_AFFINITY), 1))
                                .build()))
                ...
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("cool_mint_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.COOL_MINT_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SOUL_SPEED), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.AQUA_AFFINITY), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SWIFT_SNEAK), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.UNBREAKING), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.MENDING), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.CHANNELING), 1))
                                .build()))
                .define('D', RecastingItems.FROST_VORTEX_CORE.get())
                .define('C', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.DRIVE_RELEASE.getId(), 1))
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("cool_mint_lambda_recipe"));
         ...
         */SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.STARTLED_SWAN.location())
                ...
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("startled_swan_recipe"));
         ...
         */SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.STARTLED_SWAN_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.UNBREAKING), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.MENDING), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.MULTISHOT), 1))
                                .build()))
                .define('C', RecastingItems.FROST_VORTEX_CORE.get())
                .define('I', Items.ENDER_EYE)
                .define('S', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.SEVER_BREAK.getId(), 1))
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("startled_swan_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.DRAGON_SCALE.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(300)
                                .refineCount(50)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FIRE_PROTECTION), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FIRE_ASPECT), 1))
                                .build()))
                .define('C', RecastingItems.COPPER_MEDIUM_SOUL_CUBE.get())
                .define('I', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.SPLIT.getId(), 1))
                .unlockedBy("has_copper_medium_soul_cube", has(RecastingItems.COPPER_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("dragon_scale_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.DRAGON_SCALE_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .refineCount(200)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FIRE_PROTECTION), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FIRE_ASPECT), 2))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FLAME), 1))
                                .build()))
                .define('C', RecastingItems.COPPER_MEDIUM_SOUL_CUBE.get())
                .define('I', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.IMPACT.getId(), 1))
                .unlockedBy("has_copper_medium_soul_cube", has(RecastingItems.COPPER_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("dragon_scale_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.DRAGON.location())
                ...
                .unlockedBy("has_blazing_flame_core", has(RecastingItems.BLAZING_FLAME_CORE.get()))
                .save(output, Recasting.prefix("dragon_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.DRAGON_LAMBDA.location())
                ...
                .define('S', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.SPIRAL.getId(), 1))
                .unlockedBy("has_illuminating_truth_core", has(RecastingItems.ILLUMINATING_TRUTH_CORE.get()))
                .save(output, Recasting.prefix("dragon_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.WIND_CLOUD.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(1500)
                                .refineCount(400)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.POWER), 5))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.PUNCH_ARROWS), 2))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.INFINITY_ARROWS), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.PIERCING), 3))
                                .build()))
                .define('C', RecastingItems.ILLUMINATING_TRUTH_CORE.get())
                .define('W', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.WHIRLWIND.getId(), 1))
                .unlockedBy("has_illuminating_truth_core", has(RecastingItems.ILLUMINATING_TRUTH_CORE.get()))
                .save(output, Recasting.prefix("wind_cloud_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.WIND_CLOUD_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.PUNCH_ARROWS), 2))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.INFINITY_ARROWS), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.PIERCING), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.LOOTING), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.BANE_OF_ARTHROPODS), 2))
                                .build()))
                .define('C', RecastingItems.ILLUMINATING_TRUTH_CORE.get())
                .define('S', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.STORM.getId(), 1))
                .define('V', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.STORM_VARIANT.getId(), 1))
                .unlockedBy("has_illuminating_truth_core", has(RecastingItems.ILLUMINATING_TRUTH_CORE.get()))
                .save(output, Recasting.prefix("wind_cloud_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.XUAN_MING.location())
                ...
                .unlockedBy("has_lapis_medium_soul_cube", has(RecastingItems.LAPIS_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("xuan_ming_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.XUAN_MING_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.LOOTING), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.BANE_OF_ARTHROPODS), 2))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.IMPALING), 1))
                                .build()))
                ...
                .unlockedBy("has_gold_medium_soul_cube", has(RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("xuan_ming_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.AZURE_VISTA.location())
                ...
                .unlockedBy("has_emerald_medium_soul_cube", has(RecastingItems.EMERALD_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("azure_vista_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.AZURE_VISTA_LAMBDA.location())
                ...
                .save(output, Recasting.prefix("azure_vista_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.DHARMA_STICK.location())
                ...
                .save(output, Recasting.prefix("dharma_stick_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.DHARMA_STICK_LAMBDA.location())
                ...
                .define('B', Items.BREAD)
                .unlockedBy("has_bread", has(Items.BREAD))
                .save(output, Recasting.prefix("dharma_stick_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.HOE.location())
                ...
                .define('S', Items.STICK)
                .unlockedBy("has_stick", has(Items.STICK))
                .save(output, Recasting.prefix("hoe_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.PHYSICS_SWORD.location())
                ...
                .define('P', SlashBladeItems.PROUDSOUL.get())
                .unlockedBy("has_iron_ingot", has(Items.IRON_INGOT))
                .save(output, Recasting.prefix("physics_sword_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.VOID_1.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .refineCount(100)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.PROTECTION), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.THORNS), 1))
                                .build()))
                .define('C', RecastingItems.IRON_MEDIUM_SOUL_CUBE.get())
                .define('S', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.SHOCK.getId(), 1))
                .unlockedBy("has_iron_medium_soul_cube", has(RecastingItems.IRON_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("void_1_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.VOID_2.location())
                ...
                .define('G', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.GROWTH.getId(), 1))
                .unlockedBy("has_netherite_medium_soul_cube", has(RecastingItems.NETHERITE_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("void_2_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.VOID_3.location())
                ...
                .unlockedBy("has_blazing_flame_core", has(RecastingItems.BLAZING_FLAME_CORE.get()))
                .save(output, Recasting.prefix("void_3_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.OBLITERATE.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FIRE_ASPECT), 2))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FLAME), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FIRE_PROTECTION), 2))
                                .build()))
                ...
                .save(output, Recasting.prefix("obliterate_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.OBLITERATE_LAMBDA.location())
                ...
                .define('R', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.REGRESSION.getId(), 1))
                .unlockedBy("has_redstone_medium_soul_cube", has(RecastingItems.REDSTONE_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("obliterate_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.SOULBLADE.location())
                ...
                .define('R', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.REGRESSION.getId(), 1))
                .unlockedBy("has_blazing_flame_core", has(RecastingItems.BLAZING_FLAME_CORE.get()))
                .save(output, Recasting.prefix("soulblade_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.SOULBLADE_LAMBDA.location())
                ...
                .define('R', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.REGRESSION.getId(), 1))
                .unlockedBy("has_blazing_flame_core", has(RecastingItems.BLAZING_FLAME_CORE.get()))
                .save(output, Recasting.prefix("soulblade_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.STAR_1.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .killCount(1000)
                                .refineCount(200)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.PROJECTILE_PROTECTION), 4))
                                .build()))
                .define('C', RecastingItems.IRON_MEDIUM_SOUL_CUBE.get())
                .define('T', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.TEAR.getId(), 1))
                .unlockedBy("has_iron_medium_soul_cube", has(RecastingItems.IRON_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("star_1_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.STAR_2.location())
                ...
                .define('B',
                        ...
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .refineCount(400)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.PROJECTILE_PROTECTION), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.THORNS), 2))
                                .build()))
                .define('W', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.WHIRLWIND.getId(), 1))
                .unlockedBy("has_whirlwind_crystal", has(RecastingItems.SE_CRYSTAL.get()))
                .save(output, Recasting.prefix("star_2_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.STAR_3.location())
                ...
                .unlockedBy("has_sever_break_crystal", has(RecastingItems.SE_CRYSTAL.get()))
                .save(output, Recasting.prefix("star_3_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.STAR_4.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.PROJECTILE_PROTECTION), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.THORNS), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.POWER), 4))
                                .build()))
                .define('C', RecastingItems.ILLUMINATING_TRUTH_CORE.get())
                .define('S', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.ANNIHILATION.getId(), 1))
                .unlockedBy("has_illuminating_truth_core", has(RecastingItems.ILLUMINATING_TRUTH_CORE.get()))
                .save(output, Recasting.prefix("star_4_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.STAR_4_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.INFINITY_ARROWS), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.MULTISHOT), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.QUICK_CHARGE), 3))
                                .build()))
                .define('C', RecastingItems.ILLUMINATING_TRUTH_CORE.get())
                .define('S', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.STORM.getId(), 1))
                .define('V', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.STORM_VARIANT.getId(), 1))
                .unlockedBy("has_illuminating_truth_core", has(RecastingItems.ILLUMINATING_TRUTH_CORE.get()))
                .save(output, Recasting.prefix("star_4_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.LASER_1.location())
                ...
                .define('F', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.FRAGMENT.getId(), 1))
                .unlockedBy("has_iron_medium_soul_cube", has(RecastingItems.IRON_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("laser_1_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.LASER_2.location())
                ...
                .unlockedBy("has_gold_medium_soul_cube", has(RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("laser_2_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.LASER_3.location())
                ...
                .define('I', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.IMPACT.getId(), 1))
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("laser_3_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.LASER_3_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.THORNS), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.PROJECTILE_PROTECTION), 4))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.RESPIRATION), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.AQUA_AFFINITY), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.UNBREAKING), 3))
                                .build()))
                .define('C', RecastingItems.FROST_VORTEX_CORE.get())
                ...
                .define('I', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.IMPACT.getId(), 1))
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("laser_3_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.MAGNETIC_STORM.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .refineCount(200)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.CHANNELING), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.IMPALING), 3))
                                .build()))
                .define('C', RecastingItems.IRON_MEDIUM_SOUL_CUBE.get())
                .define('T', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.THUNDER_STRIKE.getId(), 1))
                .unlockedBy("has_iron_medium_soul_cube", has(RecastingItems.IRON_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("magnetic_storm_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.MAGNETIC_STORM_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .refineCount(400)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.CHANNELING), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.IMPALING), 5))
                                .build()))
                .define('C', RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get())
                .define('I', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.IONIZATION.getId(), 1))
                .unlockedBy("has_gold_medium_soul_cube", has(RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("magnetic_storm_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.MAGNETIC_STORM_LIMITS.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.IMPALING), 5))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.LOYALTY), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.POWER), 2))
                                .build()))
                .define('C', RecastingItems.FROST_VORTEX_CORE.get())
                .define('T', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.THUNDERSTORM.getId(), 1))
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("magnetic_storm_limits_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.MAGNETIC_STORM_LIMITS_LAMBDA.location())
                ...
                .define('T', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.THUNDERSTORM.getId(), 1))
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("magnetic_storm_limits_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.FLUORESCENCE_1.location())
                ...
                .unlockedBy("has_green_blade_wood", has(Items.GLOW_INK_SAC))
                .save(output, Recasting.prefix("fluorescence_1_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.FLUORESCENCE_2.location())
                ...
                .define('G', Items.GLOW_INK_SAC)
                .unlockedBy("has_green_blade_wood", has(Items.GLOW_INK_SAC))
                .save(output, Recasting.prefix("fluorescence_2_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.FLUORESCENCE_3.location())
                ...
                .define('G', Items.GLOW_INK_SAC)
                .unlockedBy("has_green_blade_wood", has(Items.GLOW_INK_SAC))
                .save(output, Recasting.prefix("fluorescence_3_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.FLUORESCENCE_4.location())
                ...
                .define('G', Items.GLOW_INK_SAC)
                .unlockedBy("has_green_blade_wood", has(Items.GLOW_INK_SAC))
                .save(output, Recasting.prefix("fluorescence_4_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.FLUORESCENCE_5.location())
                ...
                .define('G', Items.GLOW_INK_SAC)
                .unlockedBy("has_green_blade_wood", has(Items.GLOW_INK_SAC))
                .save(output, Recasting.prefix("fluorescence_5_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.FLUORESCENCE_6.location())
                ...
                .define('G', Items.GLOW_INK_SAC)
                .unlockedBy("has_green_blade_wood", has(Items.GLOW_INK_SAC))
                .save(output, Recasting.prefix("fluorescence_6_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.FLUORESCENCE_7.location())
                ...
                .define('G', Items.GLOW_INK_SAC)
                .unlockedBy("has_green_blade_wood", has(Items.GLOW_INK_SAC))
                .save(output, Recasting.prefix("fluorescence_7_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.FLUORESCENCE_8.location())
                ...
                .define('G', Items.GLOW_INK_SAC)
                .unlockedBy("has_green_blade_wood", has(Items.GLOW_INK_SAC))
                .save(output, Recasting.prefix("fluorescence_8_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.SILVER_WING.location())
                ...
                .define('S', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.SPLIT.getId(), 1))
                .unlockedBy("has_iron_medium_soul_cube", has(RecastingItems.IRON_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("silver_wing_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.SILVER_WING_LAMBDA.location())
                ...
                .define('V', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.STORM_VARIANT.getId(), 1))
                .unlockedBy("has_gold_medium_soul_cube", has(RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("silver_wing_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.COLOR_WING.location())
                ...
                .define('X',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SOUL_SPEED), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SWIFT_SNEAK), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FROST_WALKER), 1))
                                .build()))
                .define('C', RecastingItems.FROST_VORTEX_CORE.get())
                ...
                .unlockedBy("has_frost_vortex_core", has(RecastingItems.FROST_VORTEX_CORE.get()))
                .save(output, Recasting.prefix("color_wing_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.COLOR_WING_LAMBDA.location())
                ...
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                ...
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SOUL_SPEED), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SWIFT_SNEAK), 3))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.FROST_WALKER), 2))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.MENDING), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.CHANNELING), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.MULTISHOT), 1))
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.QUICK_CHARGE), 3))
                ...
                .define('T', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.THUNDERSTORM.getId(), 1))
                .unlockedBy("has_blazing_flame_core", has(RecastingItems.BLAZING_FLAME_CORE.get()))
                .save(output, Recasting.prefix("color_wing_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.RADIANT_STAR.location())
                ...
                .define('T', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.THUNDER_STRIKE.getId(), 1))
                .unlockedBy("has_gold_medium_soul_cube", has(RecastingItems.GOLD_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("radiant_star_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.LONG_SKY_SUNSET.location())
                ...
                .define('S', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.SPLIT.getId(), 1))
                .unlockedBy("has_redstone_medium_soul_cube", has(RecastingItems.REDSTONE_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("long_sky_sunset_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.LONG_SKY_SUNSET_LAMBDA.location())
                ...
                .define('F', SpecialEffectCrystalIngredient.of(SpecialEffectsRegistry.FRAGMENT.getId(), 1))
                .unlockedBy("has_redstone_medium_soul_cube", has(RecastingItems.REDSTONE_MEDIUM_SOUL_CUBE.get()))
                .save(output, Recasting.prefix("long_sky_sunset_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.TU_WU.location())
                ...
                .define('R', RecastingItems.BURNING_PHASE_TRANSITION.get())
                .define('T', RecastingItems.FIRE_TOXIN_PHASE_TRANSITION.get())
                .unlockedBy("has_fire_toxin_phase_transition", has(RecastingItems.FIRE_TOXIN_PHASE_TRANSITION.get()))
                .save(output, Recasting.prefix("tu_wu_recipe"));

        /**
         * 屠巫 Lambda：从屠巫升级。血咒加深——火毒/侵蚀/藏锋 各 2。
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.TU_WU_LAMBDA.location())
                ...
                .unlockedBy("has_erosion_phase_transition", has(RecastingItems.EROSION_PHASE_TRANSITION.get()))
                .save(output, Recasting.prefix("tu_wu_lambda_recipe"));

        /**
         * 轩辕·解放：从屠巫 Lambda 升级。帝光介入——交错/缠绕/致盲 各 2。
         * 要求：杀敌12000、锻造1400、锋利5
         */
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.XUAN_YUAN_LIBERATED.location())
                .pattern(" IW")
                .pattern("LBL")
                .pattern("WI ")
                .define('B',
                        SlashBladeIngredient.of(RequestDefinition.Builder.newInstance()
                                .name(RecastingSlashBladeKeys.TU_WU_LAMBDA.location())
                                .killCount(12000)
                                .refineCount(1400)
                                .addEnchantment(new EnchantmentDefinition(ench(Enchantments.SHARPNESS), 5))
                                .build()))
                ...
                .unlockedBy("has_interlace_phase_transition", has(RecastingItems.INTERLACE_PHASE_TRANSITION.get()))
                .save(output, Recasting.prefix("xuan_yuan_liberated_recipe"));

        /**
         * 轩辕·解放 Lambda：从轩辕·解放升级。毕业收束——交错/折射/蔓延 各 2。
         * 要求：杀敌15000、锻造1600、锋利5
         */
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.XUAN_YUAN_LIBERATED_LAMBDA.location())
                ...
                .unlockedBy("has_interlace_phase_transition", has(RecastingItems.INTERLACE_PHASE_TRANSITION.get()))
                .save(output, Recasting.prefix("xuan_yuan_liberated_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.FINAL_GLOW.location())
                ...
                .define('C', RecastingItems.CONCEALED_EDGE_PHASE_TRANSITION.get())
                .unlockedBy("has_detonation_phase_transition", has(RecastingItems.DETONATION_PHASE_TRANSITION.get()))
                .save(output, Recasting.prefix("final_glow_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.FINAL_GLOW_LAMBDA.location())
                ...
                .define('I', RecastingItems.INTERLACE_PHASE_TRANSITION.get())
                .unlockedBy("has_fire_toxin_phase_transition", has(RecastingItems.FIRE_TOXIN_PHASE_TRANSITION.get()))
                .save(output, Recasting.prefix("final_glow_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.VAULT_SCALE.location())
                ...
                .define('W', RecastingItems.WINDING_PHASE_TRANSITION.get())
                .define('E', RecastingItems.EROSION_PHASE_TRANSITION.get())
                .unlockedBy("has_spread_phase_transition", has(RecastingItems.SPREAD_PHASE_TRANSITION.get()))
                .save(output, Recasting.prefix("vault_scale_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.VAULT_SCALE_LAMBDA.location())
                ...
                .define('C', RecastingItems.CONCEALED_EDGE_PHASE_TRANSITION.get())
                .define('I', RecastingItems.INTERLACE_PHASE_TRANSITION.get())
                .unlockedBy("has_refraction_phase_transition", has(RecastingItems.REFRACTION_PHASE_TRANSITION.get()))
                .save(output, Recasting.prefix("vault_scale_lambda_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.STAR_THREAD.location())
                ...
                .define('W', RecastingItems.WINDING_PHASE_TRANSITION.get())
                .unlockedBy("has_refraction_phase_transition", has(RecastingItems.REFRACTION_PHASE_TRANSITION.get()))
                .save(output, Recasting.prefix("star_thread_recipe"));
        ...
        SlashBladeShapedRecipeBuilder.shaped(RecastingSlashBladeKeys.STAR_THREAD_LAMBDA.location())
                ...
                .define('R', RecastingItems.REFRACTION_PHASE_TRANSITION.get())
                .unlockedBy("has_interlace_phase_transition", has(RecastingItems.INTERLACE_PHASE_TRANSITION.get()))
                .save(output, Recasting.prefix("star_thread_lambda_recipe"));

    }

    private Holder<Enchantment> ench(ResourceKey<Enchantment> key) {
        return this.lookup.join().lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(key);
    }
}