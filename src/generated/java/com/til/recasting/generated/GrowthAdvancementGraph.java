...
public final class GrowthAdvancementGraph {
     ...
     * 项目运行时消费的附魔加成直线链。
     */
    public static final List<ResourceKey<Enchantment>> ENCHANT_BONUS_CHAIN = List.of(
            Enchantments.SMITE,
    ...
    private static BladeNode menuBlade(ResourceKey<SlashBladeDefinition> blade,
                                       @Nullable String recipePath) {
        return menuBlade(blade, null, recipePath);
    }

    private static BladeNode menuBlade(ResourceKey<SlashBladeDefinition> blade,
                                       @Nullable ResourceKey<SlashBladeDefinition> parent,
                                       @Nullable String recipePath) {
        return blade(blade, parent, recipePath, false, true);
    }
    ...
    public static final List<BladeNode> BLADES = List.of(
            ...
            blade(RecastingSlashBladeKeys.XUAN_MING, RecastingSlashBladeKeys.DRAGON_SCALE_LAMBDA, "xuan_ming_recipe", false),
            blade(RecastingSlashBladeKeys.XUAN_MING_LAMBDA, RecastingSlashBladeKeys.XUAN_MING, "xuan_ming_lambda_recipe", true),
            blade(RecastingSlashBladeKeys.WIND_CLOUD, RecastingSlashBladeKeys.XUAN_MING_LAMBDA, "wind_cloud_recipe", false),
            ...
            blade(RecastingSlashBladeKeys.RADIANT_STAR, RecastingSlashBladeKeys.COLOR_WING, "radiant_star_recipe", false),
