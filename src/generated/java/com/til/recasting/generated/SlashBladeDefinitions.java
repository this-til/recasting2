...
public final class SlashBladeDefinitions {
    ...
    public static void registerAll(BootstrapContext<SlashBladeDefinition> bootstrap) {
        ...
        register(bootstrap, RecastingSlashBladeKeys.JIE_YUAN_DOG)
                ...
                .addEnchantmentDefinition(new EnchantmentDefinition(ench(bootstrap, Enchantments.SHARPNESS), 1))
        ...
        register(bootstrap, RecastingSlashBladeKeys.LONG_SKY_SUNSET_LAMBDA)
                ...
                .addEnchantmentDefinition(new EnchantmentDefinition(ench(bootstrap, Enchantments.SHARPNESS), 2))
                .addSpecialEffects(SpecialEffectsRegistry.LONG_SKY_SUNSET, 1)
                .build();
        ...
        register(bootstrap, RecastingSlashBladeKeys.LASER_3)
                ...
                .addEnchantmentDefinition(new EnchantmentDefinition(ench(bootstrap, Enchantments.SHARPNESS), 3))
    ...
    private static Holder<Enchantment> ench(
            BootstrapContext<SlashBladeDefinition> bootstrap,
            ResourceKey<Enchantment> key
    ) {
        return bootstrap.lookup(Registries.ENCHANTMENT).getOrThrow(key);
    }

    private static SlashBladeDefinitionBuild register(
            BootstrapContext<SlashBladeDefinition> bootstrap,
    ...
    private static class SlashBladeDefinitionBuild {
        private final BootstrapContext<SlashBladeDefinition> bootstrap;
        ...
        public SlashBladeDefinitionBuild(BootstrapContext<SlashBladeDefinition> bootstrap, ResourceKey<SlashBladeDefinition> key) {
        ...
        public SlashBladeDefinitionBuild addSpecialEffects(
                DeferredHolder<SpecialEffect, SpecialEffect> specialEffectRegistryObject
        ) {
